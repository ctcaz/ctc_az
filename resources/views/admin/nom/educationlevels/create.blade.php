<!--
		File:	resources\views\admin\nom\educationlevels\create.blade.php
		 Ver:	1.00.003
 Purpose:	Education level create blade
...
@section('contents')
  <div class="container-fluid clearfix">
    <h2 class="h3 main-heading">Добавяне на вид образование</h2>

    <form class="" action="{{route('nom.educationlevels.store')}}" method="post">
      <div class="form-items">
        @csrf
        

        <section>
          <h6><strong>Добавяне на вид образование</strong></h6>
            <div class="row">
              <div class="col">
