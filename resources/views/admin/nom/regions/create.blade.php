<!--
		File:	resources\views\admin\nom\regions\create.blade.php
		 Ver:	1.00.003
 Purpose:	Region create blade
...
@section('contents')
  <div class="container-fluid clearfix">
    <h2 class="h3 main-heading">Добавяне на пол</h2>

    <form class="" action="{{route('nom.regions.store')}}" method="post">
      <div class="form-items">
        ...
        <section>
          <h6><strong>Добавяне на пол</strong></h6>
            <div class="row">
              <div class="col">
