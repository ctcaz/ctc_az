<?php /*<!--
		File:	resources\views\admin\nom\computerskills\create.blade.php
		 Ver:	1.00.003
 Purpose:	Computer skills create blade
...
@section('contents')
  <div class="container-fluid clearfix">
    <h2 class="h3 main-heading">Добавяне на компютърни умения</h2>

    <form class="" action="{{route('nom.computerskills.store')}}" method="post">
      <div class="form-items">
        @csrf


        <section>
          <h6><strong>Добавяне на компютърни умения</strong></h6>
            <div class="row">
              <div class="col">
