          ...
          <h6><strong>Корекция на категория за управление на МПС</strong></h6>
            <div class="row">
              <div class="col">
                ...
                <input type="text" name="name" autocomplete="off" value="{{$n_carcategory->name}}" class="form-control">
              </div>


              <div class="col">
                <label for="name_en">Наименование EN:</label>
                <input type="text" name="name_en" autocomplete="off" value="{{$n_carcategory->name_en}}" class="form-control">
              </div>
