...
<div class="container-fluid clearfix">
		<nav class="site-nav">
				<ul class="nav-x center">
					<li class="{{Request::url()==route('powr_bo.registrationrequests.index') ? 'sub-menu active':'sub-menu'}}  "    ><a href="#">Заявки</a>
							<ul class="sub-menu-wrapper">
	<li class="{{Request::url()==route('powr_bo.registrationrequests.index') ? 'active':'i'}}"  ><a href="{{route('powr_bo.registrationrequests.index')}}"><span>Заявки за регистрации</span></a></li>
					 ...
					 <li class="{{Request::url()==route('powr_bo.registered.index') ? 'active':''}}"  ><a href="{{route('powr_bo.registered.index')}}">Регистрации</a></li>
