...
@section('contents')
  <div class="container-fluid clearfix">
    ...
    <h2 class="h3 main-heading">Списък одобрени уведомления за посредническа дейност</h2>
      <div class="form-items">
        <section>
            <h3><span class="primary-bgr">Критерии за търсене</span></h3>
              <h6><strong>По данни за юридическо лице</strong></h6>
                ...
                <h6><strong>По данни за уведомление</strong></h6>

                <div class="row">
                  <div class="col-md-4">
                    <label for="">Срок за предоставяне на посреднически услуги:</label>
                    <input type="text" class="form-control" id="">
                  </div>
                  <div class="col-md-4">
