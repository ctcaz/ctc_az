  ...
  <div class="container-fluid clearfix">
      <div class="tabs">
          <ul class="nav-x clearfix">
            <li class="active"><a href="{{route('expert.reg.index')}}"><span class="inner">Отказани Регистрации</span></a></li>
            <li><a href="{{route('expert.not.index')}}"><span class="inner">Отказани Уведомления</span></a></li>
            <li><a href="{{route('expert.chg.index')}}"><span class="inner">Отказани Промени на обстоятелствата</span></a></li>
          </ul>
      </div>
