  ...
  <div class="level-1">
    <div class="container-fluid clearfix">
      <div class="site-logo float-left clearfix">
          <a href="https://www.az.government.bg/"><i class="float-left"><img src="{{asset('img/az-logo-bg.png')}}" alt="Агенция по заетостта" /></i> <h2>Административен интерфейс <br><small class="text-secondary">частни трудови посредници и предприятия осигуряващи временна работа</small></h2></a>
      </div>
