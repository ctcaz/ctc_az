    ...
    <div class="container-fluid clearfix">
        <h2 class="text-center h4">Информационно-комуникационна платформа "Частни трудови посредници"</h2>

        <nav class="site-nav">
          <ul class="nav-x center">
                <li class="{{Request::url()==route('ra.start.index') ? 'active':''}}">
                  <a href="{{route('ra.start.index')}}">Начало</a></li>

                <li class="{{Request::url()==route('ra.agent.index') ? 'active':''}}">
                  <a href="{{route('ra.agent.index')}}">Посредник</a></li>

                <li class="{{Request::url()==route('ra.jobs.index') ? 'active':''}}">
                  <a href="{{route('ra.jobs.index')}}">СРМ</a></li>
             ...
             @endif
               ...
               <li class="{{Request::url()==route('ra.help.index') ? 'active':''}}">
                 <a href="{{route('ra.help.index')}}">Помощ</a></li>
