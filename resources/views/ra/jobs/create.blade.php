                  ...
                  <section>
                    ...
                    <div class="row">
                      <div class="col">
                        ...
                        <select name="professionspecialty_id" id="professionspecialty_id" class="form-control">
                                  ...
                                  <optgroup label="&nbsp;&nbsp;&nbsp;&nbsp;{{$secondLvl->code . ' - ' . $secondLvl->name}}">
                                    @foreach ($lvl3 as $thirdLvl)
                                      @if ($secondLvl->id == $thirdLvl->parent_id)
                                        <optgroup label="&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;{{$thirdLvl->code . ' - ' . $thirdLvl->name}}">
                                          @foreach ($lvl4 as $fourthLvl)
                                            @if ($thirdLvl->id == $fourthLvl->prof_group_id)
                                              <option value="{{$fourthLvl->id}}">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;{{$fourthLvl->code . ' - ' . $fourthLvl->name}}</option>
                                            @endif
                                          @endforeach
                                        @endif
                                      @endforeach
                    ...
                    <div class="row">
                      <div class="col">
                        <label for="decimalofjobs">Брой места общо:*</label>
                      ...
                      <div class="col">
                        <div class="form-check">
                          <br>
                          <input class="form-check-input" type="checkbox" id="trn_coststo_bg_incl" name="trn_coststo_bg_incl">
                          <label class="form-check-label" for="trn_coststo_bg_incl">Сезонна заетост</label>
                        </div>
                      </div>

                      <div class="col">
                        <label for="">Свободно от дата:*</label>
                        <input type="date" class="datepicker-bg.js" name="jobavailablefrom" id="jobavailablefrom">
                      </div>
                    </div>
                    ...
                    <div class="row">
                      ...
                      <div class="col">
                        ...
                        <input type="number" class="form-control" id="add_remun_soc_benefits" name="add_remun_soc_benefits" step=".01">
                      </div>
                      <div class="col">
                        <label for="amountto">Трудово възнаграждение (валута)</label>
                        <input type="number" class="form-control" id="amountto" name="amountto" step=".01">
                      </div>
                      <div class="col-md-2">
                        <label for="">Валута</label>
