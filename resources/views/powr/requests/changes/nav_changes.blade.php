    ...
    <ul class="nav-x center">
        <li class="sub-menu active"><a href="{{route('expert.registration.index')}}">Заявки</a>
            <ul class="sub-menu-wrapper">
              ...
              <li class="active"><a href="{{route('expert.changes.index')}}"><span>Заявки за промяна на обстоятелства</span></a></li>
            </ul>
         </li>
         ...
         <li class="sub-menu"><a href="{{route('expert.seeking.index')}}">ТРЛ и УРЛ</a>
            <ul class="sub-menu-wrapper">
              ...
              <li><a href="{{route('expert.found.index')}}"><span>Устроени на работа лица</span></a></li>
            </ul>
         </li>
      </ul>
  </nav>
